...
TEST_CASE( "Algoly: PassRef: local modify closed array by ref", "[algoly][pass-ref]" )
{
    ...
    TestCompileAndRunAlgoly( code, 3, 0, 9 );
}
...
TEST_CASE( "Algoly: PassRef: local modify closed sliced array by ref", "[algoly][pass-ref]" )
{
    ...
    TestCompileAndRunAlgoly( code, 4, 0, 10 );
}
...
TEST_CASE( "Algoly: PassRef: global array call chain by ref", "[algoly][pass-ref]" )
{
    ...
    TestCompileAndRunAlgoly( code, 15, 0, 10 );
}
...
TEST_CASE( "Algoly: PassRef: local array call chain by ref", "[algoly][pass-ref]" )
{
    ...
    TestCompileAndRunAlgoly( code, 15, 0, 10+3 );
}
...
TEST_CASE( "Algoly: PassRef: local slice array call chain by ref", "[algoly][pass-ref]" )
{
    ...
    TestCompileAndRunAlgoly( code, 15, 0, 10+4 );
}
...
TEST_CASE( "Algoly: PassRef: global array to fptr taking ref", "[algoly][pass-ref]" )
{
    ...
    TestCompileAndRunAlgoly( code, 6, 0, 5 );
}
...
TEST_CASE( "Algoly: PassRef: global pass whole part of multidim by ref, const indexes", "[algoly][pass-ref]" )
{
    ...
    TestCompileAndRunAlgoly( code, 105, 0, 8 );
}
...
TEST_CASE( "Algoly: PassRef: local pass whole part of multidim by ref, const indexes", "[algoly][pass-ref]" )
{
    ...
    TestCompileAndRunAlgoly( code, 105, 0, 8+4 );
}
...
TEST_CASE( "Algoly: PassRef: global countof open range of open array", "[algoly][pass-ref]" )
{
    ...
    TestCompileAndRunAlgoly( code, 2, 0, 12 );
}
...
TEST_CASE( "Algoly: PassRef: local countof open range of open array", "[algoly][pass-ref]" )
{
    ...
    TestCompileAndRunAlgoly( code, 2, 0, 12+3 );
}

TEST_CASE( "Algoly: PassRef: global countof open range of open array, open start", "[algoly][pass-ref]" )
{
    const char code[] =
        "var ar: [4] := [1, 2, 3, 4]\n"
        "def a\n"
    ...
    TestCompileAndRunAlgoly( code, 3, 0, 12 );
}

TEST_CASE( "Algoly: PassRef: global countof open range of open array, open end", "[algoly][pass-ref]" )
{
    const char code[] =
        "var ar: [4] := [1, 2, 3, 4]\n"
        "def a\n"
...
TEST_CASE( "Algoly: PassRef: global countof open range of open array, open both", "[algoly][pass-ref]" )
{
    const char code[] =
        "var ar: [4] := [1, 2, 3, 4]\n"
        "def a\n"
...
TEST_CASE( "Algoly: PassRef: global countof open range of open array, open both, 3x", "[algoly][pass-ref]" )
{
    const char code[] =
        "var ar: [4] := [1, 2, 3, 4]\n"
        "def a\n"
...
TEST_CASE( "Algoly: PassRef: global countof closed range of closed array", "[algoly][pass-ref]" )
{
    const char code[] =
        "var ar: [4] := [1, 2, 3, 4]\n"
        "def a\n"
...
TEST_CASE( "Algoly: PassRef: global countof closed range of closed array, open start", "[algoly][pass-ref]" )
{
    const char code[] =
        "var ar: [4] := [1, 2, 3, 4]\n"
        "def a\n"
...
TEST_CASE( "Algoly: PassRef: global countof closed range of closed array, open end", "[algoly][pass-ref]" )
{
    const char code[] =
        "var ar: [4] := [1, 2, 3, 4]\n"
        "def a\n"
...
TEST_CASE( "Algoly: PassRef: global countof closed range of closed array, open both", "[algoly][pass-ref]" )
{
    const char code[] =
        "var ar: [4] := [1, 2, 3, 4]\n"
        "def a\n"
...
TEST_CASE( "Algoly: PassRef: global modify open array", "[algoly][pass-ref]" )
{
    ...
    TestCompileAndRunAlgoly( code, 13, 0, 11 );
}
...
TEST_CASE( "Algoly: PassRef: local modify open array", "[algoly][pass-ref]" )
{
    ...
    TestCompileAndRunAlgoly( code, 13, 0, 14 );
}
...
TEST_CASE( "Algoly: PassRef: global modify open array of 2x2", "[algoly][pass-ref]" )
{
    ...
    TestCompileAndRunAlgoly( code, 99+2, 0, 10 );
}
...
TEST_CASE( "Algoly: PassRef: local modify open array of 2x2", "[algoly][pass-ref]" )
{
    ...
    TestCompileAndRunAlgoly( code, 99+2, 0, 10 + 4 );
}
...
TEST_CASE( "Algoly: PassRef: global pass open array open array", "[algoly][pass-ref]" )
{
    ...
    TestCompileAndRunAlgoly( code, 12, 0, 14 );
}
...
TEST_CASE( "Algoly: PassRef: local pass open array open array", "[algoly][pass-ref]" )
{
    ...
    TestCompileAndRunAlgoly( code, 12, 0, 14+3 );
}
...
TEST_CASE( "Algoly: PassRef: global pass open array slice open array", "[algoly][pass-ref]" )
{
    ...
    TestCompileAndRunAlgoly( code, 11, 0, 14 );
}
...
TEST_CASE( "Algoly: PassRef: local pass open array slice open array", "[algoly][pass-ref]" )
{
    ...
    TestCompileAndRunAlgoly( code, 11, 0, 14 + 3 );
}
...
TEST_CASE( "Algoly: PassRef: global pass whole part to open array open array", "[algoly][pass-ref]" )
{
    ...
    TestCompileAndRunAlgoly( code, 30, 0, 14 );
}
...
TEST_CASE( "Algoly: PassRef: local pass whole part to open array open array", "[algoly][pass-ref]" )
{
    ...
    TestCompileAndRunAlgoly( code, 30, 0, 20 + 3 );
}
...
TEST_CASE( "Algoly: PassRef: global pass whole part to open array slice open array", "[algoly][pass-ref]" )
{
    ...
    TestCompileAndRunAlgoly( code, 29, 0, 14 );
}
...
TEST_CASE( "Algoly: PassRef: local pass whole part to open array slice open array", "[algoly][pass-ref]" )
{
    ...
    TestCompileAndRunAlgoly( code, 29, 0, 14 + 9 );
}
...
TEST_CASE( "Algoly: open array, closed slice, var index", "[algoly][pass-ref][bounds]" )
{
    const char code[] =
        "var one := 1\n"
        "var three := 3\n"
...
TEST_CASE( "Algoly: PassRef: closed slice of array in record in var indexed global array", "[algoly][pass-ref][bounds]" )
{
    const char code[] =
        "var one := 1\n"
        "var three := 3\n"
